...
class Backbone(nn.Module):
  ...
  def forward(self, x):
    ...
    # first layer
    x, skips, os = self.run_layer2(x, self.conv1, skips, os)
    x, skips, os = self.run_layer2(x, self.bn1, skips, os)
    x, skips, os = self.run_layer2(x, self.relu1, skips, os)

    # all encoder blocks with intermediate dropouts
    x, skips, os = self.run_layer1(x, self.enc1, skips, os)
    x, skips, os = self.run_layer2(x, self.dropout, skips, os)
    x, skips, os = self.run_layer1(x, self.enc2, skips, os)
    x, skips, os = self.run_layer2(x, self.dropout, skips, os)
    x, skips, os = self.run_layer1(x, self.enc3, skips, os)
    x, skips, os = self.run_layer2(x, self.dropout, skips, os)
    x, skips, os = self.run_layer1(x, self.enc4, skips, os)
    x, skips, os = self.run_layer2(x, self.dropout, skips, os)
    x, skips, os = self.run_layer1(x, self.enc5, skips, os)
    x, skips, os = self.run_layer2(x, self.dropout, skips, os)
